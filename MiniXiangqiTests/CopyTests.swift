...
struct CopyTests {
    ...
    func everyKeyAnswersInBothLanguages() throws {
        ...
        let keys = [
            ...
            "alert.importIllegalStart.title", "alert.importIllegalStart.message",
            ...
            "scene.reason.generals", "scene.reason.pieceCount",
            "scene.reason.palace", "scene.reason.advisorPoint",
            "scene.reason.elephantSide",
            "scene.reason.soldierRank", "scene.reason.facingGenerals",
            "scene.reason.opponentInCheck", "scene.reason.decided",
            ...
            "nearby.refusal.unknownSession", "nearby.refusal.dealMismatch",
            ...
            "online.friend", "online.friend.footer", "online.invite",
            "online.code", "online.code.yours", "online.code.enter",
            "online.code.join", "online.code.footer",
            "online.interrupted",
