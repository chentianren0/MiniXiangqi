...
- Define the haptic events outside board play. Board play's haptic set is defined under [Sound and haptics](#sound-and-haptics), and each half now follows its own accepted preference wherever it would fire. Where and how the two toggles are presented is settled there too, both platforms' answers to the hardware question included.
