...
- The Apple frontend's Xcode project sits under `apple/`. It was relocated there while it was still the generated scaffold, so the move changed file locations and the project's references to them and nothing else about the build.
