...
- Verify no resident surface intersects the board block, that a user-summoned sheet may cover it, and that the natural-result card leaves the final board fully visible.
