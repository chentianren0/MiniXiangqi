...
- Verify a jieqi hidden loss stands as face-down discs at its row's end — the face-down body, never a stone — and resolves into identified pieces at disclosure. Verify a shown loss that left the board face down is told from an open capture, its symbol partway arrived, and that the telling survives disclosure.
